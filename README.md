...
```bash
git clone https://github.com/al3xandru/dotfiles.git && cd dotfiles && source bootstrap.sh
```
...
```bash
cd; curl -#L https://github.com/al3xandru/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh}
```
...
### Extras and overriding settings
...
* [Mathias Bynens](https://github.com/mathiasbynens/dotfiles) for his work on this
